...
// The SDK ships a CJS export shaped as the client class (possibly under
// `.default` depending on resolution); normalize once so construction works
// regardless. Typed as any because the package's own types describe the ESM
// namespace, not the resolved CJS value.
/** @type {any} */
const Anthropic = AnthropicSdk && AnthropicSdk.default ? AnthropicSdk.default : AnthropicSdk;
