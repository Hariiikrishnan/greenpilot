...
// adminOrOrgManager (Phase 12): instance admins pass; otherwise the caller
// must be acting inside an organization (req.org, set by resolveTenant) as
// its owner/admin. Pure role check — no DB. Used for workspace-setup
// mutations (WhatsApp connect, CRM bootstrap) so a SaaS org owner can set up
// their own org without instance-admin rights. Same pattern as billing's
// requireBillingManager; cross-org access is still impossible because req.org
// itself derives from membership.
