...
async function seed() {
  ...
  try {
    ...
    const tpls = [
      [101, 'welcome_message', 'UTILITY', 'en', 'NONE', null, 'Hi {{1}}, welcome to Green Pilot! How can we help you today?', 'Reply STOP to opt out', '[{"type":"QUICK_REPLY","text":"Pricing"},{"type":"QUICK_REPLY","text":"Site Visit"}]', '{"1":"Anjali"}', 'APPROVED'],
      ...
      [103, 'otp_verify', 'AUTHENTICATION', 'en', 'NONE', null, 'Your Green Pilot verification code is {{1}}. Valid for 10 minutes.', null, '[{"type":"OTP","text":"Copy Code","otpType":"COPY_CODE"}]', '{"1":"123456"}', 'APPROVED'],
